...
export function Homepage() {
  ...
  useEffect(() => {
    ...
    const fetchJwtWithUuid = async () => {
      ...
      if (uuid) {
        try {
          // const response = await axios.get(`http://localhost:8080/empoweru/sba/user/google-principal?uuid=${uuid}`);
          const response = await axios.get(
            `https://empoweru.com.vn:8080/empoweru/sba/user/google-principal?uuid=${uuid}`
          );
