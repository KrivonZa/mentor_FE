        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex" style={{ gap: "10px" }}>
            <Button
              ...
              type="primary"
              className="bg-danger"
              onClick={() => handleResolveRequest("BAN")}
            >
              Ban
            </Button>
            <Button
      ...
      <div style={{ padding: "16px" }}>
        ...
        <Descriptions bordered column={1} style={{ marginBottom: "24px" }}>
          <Descriptions.Item label="Course ID">
            {courseDetailFormData?.courseDetail?.courseID}
          </Descriptions.Item>
          <Descriptions.Item label="Course Name">
            {courseDetailFormData?.courseDetail?.courseName}
          </Descriptions.Item>
          <Descriptions.Item label="Level">
            <Text strong>{courseDetailFormData?.courseDetail?.level}</Text>
          </Descriptions.Item>
          <Descriptions.Item label="Description">
            <div
              className="rich-text-content"
              dangerouslySetInnerHTML={{
                __html: courseDetailFormData?.courseDetail?.description,
              }}
            />
          </Descriptions.Item>
          ...
          {courseDetailFormData?.courseDetail?.lesson.map((lesson) => (
            ...
            >
              <div>
                ...
                <br />
                <Text type="secondary">
                  Trial Lesson: {lesson.trialLesson ? "Yes" : "No"}
                </Text>
              </div>
            </Descriptions.Item>
          ))}
        ...
        <Descriptions bordered column={1} style={{ marginBottom: "24px" }}>
          <Descriptions.Item label="Mentor ID">
            {courseDetailFormData?.mentorDetail?.mentorID}
          </Descriptions.Item>
          <Descriptions.Item label="Mentor Name">
            <Avatar
              src={courseDetailFormData?.mentorDetail?.avatar}
        ...
        <Descriptions bordered column={1}>
          <Descriptions.Item label="Request ID">
            {courseDetailFormData?.courseApprovalRequestID}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Assignee ID">
            {courseDetailFormData?.assigneeID || "Not assigned"}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Created At">
            {new Date(courseDetailFormData?.createdAt).toLocaleString()}
          </Descriptions.Item>
          <Descriptions.Item label="Updated At">
            {new Date(courseDetailFormData?.updatedAt).toLocaleString()}
          </Descriptions.Item>
        </Descriptions>
      </div>
    </Modal>
